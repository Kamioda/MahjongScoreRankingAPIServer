...
import ReadAPIConfig from './features/loader/config';
import AccountManager, { NewUserInformation } from './features/Account';
import AccessTokenManager from './features/AccessTokenManager';
import ScoreManager from './features/ScoreManager';
import { createAccountSpec } from './features/specs/account/create';
import { signinSpec } from './features/specs/account/signin';
import { newRecordSpec } from './features/specs/record/new';
import { updateAccountSpec } from './features/specs/account/update';
import { writeFileSync } from 'fs';
import { changePasswordSpec } from './features/specs/account/changePassword';
import { changePrivilegeSpec } from './features/specs/account/changePrivilege';
const { isValid } = pkg;
